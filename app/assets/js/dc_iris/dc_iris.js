...
d3.json("http://tranquil-peak-82564.herokuapp.com/api/v1.0/data/iris/", function(remote_json) {
  ...
  var showButton = function() {
    if (sepal_length_chart.filters().length > 0 || species_chart.filters().length > 0 || petal_length_chart.filters().length > 0 || sepal_width_chart.filters().length > 0 || petal_width_chart.filters().length > 0) {
      d3.select(".btn-btn")
        .remove();
